export async function getLatestGames(offset) {
  const LATEST_GAMES =
    `https://internal-prod.apigee.fandom.net/v1/xapi/finder/metacritic/web?sortBy=-metaScore&productType=games&page=1&releaseYearMin=1958&releaseYearMax=2024&offset=${offset}&limit=24&apiKey=1MOZgmNFxvmljaQR1X9KAij9Mo4xAY3u`;
